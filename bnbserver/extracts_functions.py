...
def get_raster_value(X, Y, distance, feature="igntop202103_bat_hauteur"):
    """
    parameters:
    ...
    for element in vector_data: 
        ...
        feature_value = element["properties"][feature]
    ...
    gdf = gpd.GeoDataFrame(feature, geometry=geometries, columns=[feature])
